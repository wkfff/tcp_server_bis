...
def result_of_method(str_xml):
    ...
    return_root.find('GetID').text = body.find('REPORT_NO').text + '-' + body.find('TEST_ITEM_CODE').text
    ...
    return_root.find('TestDate').text = body.find('RECEIVE_DATE').text.replace('T', ' ')
    return_root.find('ReportTime').text = body.find('REPORT_DATE').text.replace('T', ' ')
