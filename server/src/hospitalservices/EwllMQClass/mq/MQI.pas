...
procedure MQCLOSE(HConn: MQHCONN; HObj: PMQHOBJ; Options: MQLONG; Compcode,
  Reason: PMQLONG); cdecl; external 'mqm.dll';
...
procedure MQINQ(Hconn: MQHCONN; HObj: MQHOBJ; SelectorCount: MQLONG; Selectors:
  ...
  CharAttrs: PMQCHAR; CompCode, Reason: PMQLONG); cdecl; external 'mqm.dll';
