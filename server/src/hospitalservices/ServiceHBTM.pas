...
//
//type
//  THBTMInterfaceObject = class(TQService, IHospitalBISService)
//  protected
//    /// <summary>
//    /// 获取病人信息
//    /// </summary>
...
//
//function THBTMInterfaceObject.DeleteClinicalRequisitionOrder(const ARecvXML: TQXML;
...
//end;
//
//function THBTMInterfaceObject.GetChargeItemInfos(const ARecvXML: TQXML;
//  var ASendXML: TQXML): Boolean;
//begin
//
//end;
//
//function THBTMInterfaceObject.GetDeptInfos(const ARecvXML: TQXML;
//  var ASendXML: TQXML): Boolean;
//begin
//
//end;
//
//function THBTMInterfaceObject.GetDiagnosesInfos(const ARecvXML: TQXML;
//  var ASendXML: TQXML): Boolean;
//begin
//
//end;
//
//function THBTMInterfaceObject.GetPateintInfos(const ARecvXML: TQXML;
//  var ASendXML: TQXML): Boolean;
//var
//  APatientId: string;
//  ANums: Integer;
...
//end;
//
//function THBTMInterfaceObject.GetStaffInfos(const ARecvXML: TQXML;
//  var ASendXML: TQXML): Boolean;
//begin
//
//end;
//
//function THBTMInterfaceObject.GetSurgeryInfos(const ARecvXML: TQXML;
//  var ASendXML: TQXML): Boolean;
//begin
//
//end;
//
//function THBTMInterfaceObject.GetTestItemInfos(const ARecvXML: TQXML;
//  var ASendXML: TQXML): Boolean;
//begin
//
//end;
//
//function THBTMInterfaceObject.GetTestItemResultInfos(const ARecvXML: TQXML;
//  var ASendXML: TQXML): Boolean;
//var
...
//end;
//
//function THBTMInterfaceObject.GetTreatmentItemInfos(const ARecvXML: TQXML;
//  var ASendXML: TQXML): Boolean;
//begin
//
//end;
//
//function THBTMInterfaceObject.GetWardInfos(const ARecvXML: TQXML;
//  var ASendXML: TQXML): Boolean;
//begin
//
//end;
//
//function THBTMInterfaceObject.SendClinicalRequisitionOrder(const ARecvXML: TQXML;
//  var ASendXML: TQXML): Boolean;
//var
//  AInput: TQXML;
//  AOut: TQXML;
...
//  RegisterServices('Services/Interface', [THBTMInterfaceObject.Create(IHospitalBISServiceIntf, HospitalCode)]);
