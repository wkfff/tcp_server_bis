...
const
  ...
  MAX_OBJECT_SIZE = 1024 * 1024 * 10;
    //最大对象大小 10M , 大于10M 则会认为错误的包。

function TIOCPStreamDecoder.Decode(const inBuf: TBufferLink; pvContext: TObject): TObject;
var
...
procedure TIOCPStreamEncoder.Encode(pvDataObject: TObject; const ouBuf: TBufferLink);
var
  lvPACK_FLAG: WORD;
