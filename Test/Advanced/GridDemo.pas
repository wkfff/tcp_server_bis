...
uses
  ...
  StdCtrls, VirtualTrees, ImgList, Menus, System.ImageList;
...
type
  TGridForm = class(TForm)
    ...
    procedure VST5NodeMoved(Sender: TBaseVirtualTree; Node: PVirtualNode);
  end;
...
procedure TGridForm.VST5NodeMoved(Sender: TBaseVirtualTree; Node: PVirtualNode);
begin
